...
function searching(event){
	...
	if (userInput === "") {
		$results.append("<li class='list-item' id='error'><h2 class='item-header'>Please enter search inquiry</h2></li>");
		return false;
	}
	...
	$.ajax({
		...
		error: function(){
			$results.append("<li class='list-item' id='error'><h2 class='item-header'>Error! Could not retrieve data</h2></li>");
			}
	});
}
